...
import static com.example.training.enums.UploadModeEnum.getStrategy;
...
public class UploadStrategyContext {
    ...
    public List<String> executeUploadMultipleStrategy(MultipartFile[] file, String path) {
        return uploadStrategyMap.get(getStrategy(uploadMode)).uploadFiles(file, path);
    }
}
