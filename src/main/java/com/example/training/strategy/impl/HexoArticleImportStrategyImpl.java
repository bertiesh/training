...
import com.example.training.strategy.ArticleImportStrategy;
import com.example.training.vo.HexoArticleVO;
...
import static com.example.training.constant.HexoConst.*;
...
import static com.example.training.enums.ArticleTypeEnum.ORIGINAL;
...
public class HexoArticleImportStrategyImpl implements ArticleImportStrategy {
    ...
    public void importArticles(MultipartFile file) {
        try {
            ...
            hexoArticleVO.setArticleTitle("markdown");
